    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit_balance', models.DecimalField(decimal_places=2, default=0, help_text='Udhaar amount', max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_name', models.CharField(blank=True, default='Walk-in Customer', max_length=255)),
                ...
                ('payment_method', models.CharField(choices=[('CASH', 'Cash'), ('UPI', 'UPI'), ('CARD', 'Card'), ('CREDIT', 'Credit (Udhaar)'), ('MIXED', 'Mixed Payment')], default='CASH', max_length=10)),
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('COMPLETED', 'Completed'), ('CANCELLED', 'Cancelled')], default='COMPLETED', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicine', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoice_items', to='inventory.medicine')),
            ],
            options={
                'ordering': ['id'],
            },
